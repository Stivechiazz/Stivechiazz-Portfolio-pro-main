      ...
      <form className="flex flex-col items-center border border-primary rounded-lg p-6 max-w-lg mx-auto text-white">
        ...
        <div className="mb-4">
          <p className="text-purple-400 font-bold">
            Email:{" "}
            <a href="mailto:stephengichia85@gmail.com" className="hover:underline">
        ...
        <div className="mb-6 flex gap-2">
          ...
          <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="text-white text-sm font-medium flex items-center gap-1">
